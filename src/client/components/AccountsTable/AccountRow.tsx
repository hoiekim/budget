    ...
    return (
      ...
      >
        <div className="accountTitle">
          {/* Only render the color chip when a donut-mapped color was passed.
           *  Archived and hidden rows call AccountRow without a color, and an
           *  empty `.colorTag` div reads as left indentation. */}
