...
export const upsertInstitutions = async (institutions: JSONInstitution[]): Promise<UpsertResult[]> => {
...
export const searchInstitutionsById = async (institution_ids: string[]): Promise<JSONInstitution[]> => {
