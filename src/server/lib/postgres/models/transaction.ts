...
const txSchema = {
  ...
  [LABEL_MEMO]: "TEXT",
  [LABEL_IS_SUGGESTED]: "BOOLEAN DEFAULT FALSE",
  [RAW]: "JSONB",
...
export class TransactionModel extends Model<JSONTransaction, TxSchema> implements TxRow {
  ...
  declare label_is_suggested: boolean | null;
  ...
  static typeChecker = {
    ...
    label_is_suggested: isNullableBoolean,
  ...
  static fromJSON(
    ...
    if (!isUndefined(tx.authorized_date || tx.date)) r.date = tx.authorized_date || tx.date;
